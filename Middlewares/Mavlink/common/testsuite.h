...
static void mavlink_test_fmt_pos_yaw(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FMT_POS_YAW >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fmt_pos_yaw_t packet_in = {
        963497464,963497672,73.0,101.0,129.0,157.0,77,144,211
    };
    mavlink_fmt_pos_yaw_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.vx = packet_in.vx;
        ...
        packet1.node_type = packet_in.node_type;
        packet1.team_id = packet_in.team_id;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FMT_POS_YAW_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FMT_POS_YAW_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_pos_yaw_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fmt_pos_yaw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_pos_yaw_pack(system_id, component_id, &msg , packet1.lat , packet1.lon , packet1.vx , packet1.vy , packet1.alt , packet1.yaw , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_pos_yaw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_pos_yaw_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lat , packet1.lon , packet1.vx , packet1.vy , packet1.alt , packet1.yaw , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_pos_yaw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fmt_pos_yaw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_pos_yaw_send(MAVLINK_COMM_1 , packet1.lat , packet1.lon , packet1.vx , packet1.vy , packet1.alt , packet1.yaw , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_pos_yaw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_attack_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ATTACK_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_attack_status_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,65
    };
    mavlink_attack_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.attack_alt_error = packet_in.attack_alt_error;
        packet1.attack_hori_distance_error = packet_in.attack_hori_distance_error;
        packet1.attack_tilt_angle_error = packet_in.attack_tilt_angle_error;
        packet1.attack_xtrack_error = packet_in.attack_xtrack_error;
        packet1.attack_along_track_error = packet_in.attack_along_track_error;
        packet1.attack_mode = packet_in.attack_mode;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ATTACK_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ATTACK_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attack_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_attack_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attack_status_pack(system_id, component_id, &msg , packet1.attack_mode , packet1.attack_alt_error , packet1.attack_hori_distance_error , packet1.attack_tilt_angle_error , packet1.attack_xtrack_error , packet1.attack_along_track_error );
    mavlink_msg_attack_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attack_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.attack_mode , packet1.attack_alt_error , packet1.attack_hori_distance_error , packet1.attack_tilt_angle_error , packet1.attack_xtrack_error , packet1.attack_along_track_error );
    mavlink_msg_attack_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_attack_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attack_status_send(MAVLINK_COMM_1 , packet1.attack_mode , packet1.attack_alt_error , packet1.attack_hori_distance_error , packet1.attack_tilt_angle_error , packet1.attack_xtrack_error , packet1.attack_along_track_error );
    mavlink_msg_attack_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_formation_config(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FORMATION_CONFIG >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_formation_config_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504
    };
    mavlink_formation_config_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.team_id = packet_in.team_id;
        packet1.node_type = packet_in.node_type;
        packet1.x_offset = packet_in.x_offset;
        packet1.y_offset = packet_in.y_offset;
        packet1.z_offset = packet_in.z_offset;
        packet1.strength_z_offset = packet_in.strength_z_offset;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FORMATION_CONFIG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FORMATION_CONFIG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_config_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_formation_config_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_config_pack(system_id, component_id, &msg , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_config_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_config_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_config_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_formation_config_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_config_send(MAVLINK_COMM_1 , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_config_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_formation_set(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FORMATION_SET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_formation_set_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,77
    };
    mavlink_formation_set_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.team_id = packet_in.team_id;
        packet1.node_type = packet_in.node_type;
        packet1.x_offset = packet_in.x_offset;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FORMATION_SET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FORMATION_SET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_set_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_formation_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_set_pack(system_id, component_id, &msg , packet1.target_system , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_set_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_formation_set_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_set_send(MAVLINK_COMM_1 , packet1.target_system , packet1.team_id , packet1.node_type , packet1.x_offset , packet1.y_offset , packet1.z_offset , packet1.strength_z_offset );
    mavlink_msg_formation_set_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_serial_number_item(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SERIAL_NUMBER_ITEM >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_serial_number_item_t packet_in = {
        "ABCDEFGHIJKLMNO"
    };
    mavlink_serial_number_item_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        mav_array_memcpy(packet1.serial_num, packet_in.serial_num, sizeof(char)*16);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SERIAL_NUMBER_ITEM_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SERIAL_NUMBER_ITEM_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_item_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_serial_number_item_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_item_pack(system_id, component_id, &msg , packet1.serial_num );
    mavlink_msg_serial_number_item_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_item_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.serial_num );
    mavlink_msg_serial_number_item_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_serial_number_item_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_item_send(MAVLINK_COMM_1 , packet1.serial_num );
    mavlink_msg_serial_number_item_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_serial_number_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SERIAL_NUMBER_REQUEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_serial_number_request_t packet_in = {
        5,72
    };
    mavlink_serial_number_request_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SERIAL_NUMBER_REQUEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SERIAL_NUMBER_REQUEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_request_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_serial_number_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_request_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
    mavlink_msg_serial_number_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
    mavlink_msg_serial_number_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_serial_number_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_number_request_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
    mavlink_msg_serial_number_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_fmt_global_pos(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FMT_GLOBAL_POS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fmt_global_pos_t packet_in = {
        963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,20147,20251,20355
    };
    mavlink_fmt_global_pos_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FMT_GLOBAL_POS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FMT_GLOBAL_POS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_global_pos_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fmt_global_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_global_pos_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.yaw_rate , packet1.roll , packet1.pitch , packet1.yaw , packet1.speed , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_global_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_global_pos_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.yaw_rate , packet1.roll , packet1.pitch , packet1.yaw , packet1.speed , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_global_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fmt_global_pos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fmt_global_pos_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.yaw_rate , packet1.roll , packet1.pitch , packet1.yaw , packet1.speed , packet1.sys_id , packet1.node_type , packet1.team_id );
    mavlink_msg_fmt_global_pos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_flight_num_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FLIGHT_NUM_MSG >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_flight_num_msg_t packet_in = {
        "ABCDE"
    };
    mavlink_flight_num_msg_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        mav_array_memcpy(packet1.flight_num, packet_in.flight_num, sizeof(char)*6);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FLIGHT_NUM_MSG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FLIGHT_NUM_MSG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flight_num_msg_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_flight_num_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flight_num_msg_pack(system_id, component_id, &msg , packet1.flight_num );
    mavlink_msg_flight_num_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flight_num_msg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.flight_num );
    mavlink_msg_flight_num_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_flight_num_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flight_num_msg_send(MAVLINK_COMM_1 , packet1.flight_num );
    mavlink_msg_flight_num_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_target_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_target_position_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_position_pack(system_id, component_id, &msg , packet1.distance , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_target_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.distance , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_target_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_target_position_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_position_send(MAVLINK_COMM_1 , packet1.distance , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_target_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_fuze_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FUZE_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fuze_control_t packet_in = {
        963497464,17
    };
    mavlink_fuze_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.delay_ms = packet_in.delay_ms;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FUZE_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FUZE_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fuze_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_control_pack(system_id, component_id, &msg , packet1.delay_ms , packet1.cmd );
    mavlink_msg_fuze_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.delay_ms , packet1.cmd );
    mavlink_msg_fuze_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fuze_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_control_send(MAVLINK_COMM_1 , packet1.delay_ms , packet1.cmd );
    mavlink_msg_fuze_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_fuze_states(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FUZE_STATES >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fuze_states_t packet_in = {
        963497464,17,84,151,218,29,96,163,230
    };
    mavlink_fuze_states_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.delay_ms = packet_in.delay_ms;
        packet1.device_id = packet_in.device_id;
        packet1.safe = packet_in.safe;
        packet1.armed = packet_in.armed;
        packet1.deep_armed = packet_in.deep_armed;
        packet1.self_destroy = packet_in.self_destroy;
        packet1.touch_explosion = packet_in.touch_explosion;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FUZE_STATES_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FUZE_STATES_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_states_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fuze_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_states_pack(system_id, component_id, &msg , packet1.delay_ms , packet1.device_id , packet1.safe , packet1.armed , packet1.deep_armed , packet1.self_destroy , packet1.touch_explosion , packet1.countdown , packet1.lock );
    mavlink_msg_fuze_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_states_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.delay_ms , packet1.device_id , packet1.safe , packet1.armed , packet1.deep_armed , packet1.self_destroy , packet1.touch_explosion , packet1.countdown , packet1.lock );
    mavlink_msg_fuze_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fuze_states_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fuze_states_send(MAVLINK_COMM_1 , packet1.delay_ms , packet1.device_id , packet1.safe , packet1.armed , packet1.deep_armed , packet1.self_destroy , packet1.touch_explosion , packet1.countdown , packet1.lock );
    mavlink_msg_fuze_states_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_camera_pod_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CAMERA_POD_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_camera_pod_control_t packet_in = {
        17.0,45.0,29
    };
    mavlink_camera_pod_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.param1 = packet_in.param1;
        packet1.param2 = packet_in.param2;
        packet1.cmd = packet_in.cmd;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CAMERA_POD_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CAMERA_POD_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_camera_pod_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_control_pack(system_id, component_id, &msg , packet1.cmd , packet1.param1 , packet1.param2 );
    mavlink_msg_camera_pod_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cmd , packet1.param1 , packet1.param2 );
    mavlink_msg_camera_pod_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_camera_pod_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_control_send(MAVLINK_COMM_1 , packet1.cmd , packet1.param1 , packet1.param2 );
    mavlink_msg_camera_pod_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_camera_pod_states(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CAMERA_POD_STATES >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_camera_pod_states_t packet_in = {
        17.0,45.0,29,96,163
    };
    mavlink_camera_pod_states_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.yaw = packet_in.yaw;
        packet1.pitch = packet_in.pitch;
        packet1.ptz_status = packet_in.ptz_status;
        packet1.trace_status = packet_in.trace_status;
        packet1.deviceid = packet_in.deviceid;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CAMERA_POD_STATES_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CAMERA_POD_STATES_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_states_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_camera_pod_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_states_pack(system_id, component_id, &msg , packet1.yaw , packet1.pitch , packet1.ptz_status , packet1.trace_status , packet1.deviceid );
    mavlink_msg_camera_pod_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_states_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.yaw , packet1.pitch , packet1.ptz_status , packet1.trace_status , packet1.deviceid );
    mavlink_msg_camera_pod_states_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_camera_pod_states_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_camera_pod_states_send(MAVLINK_COMM_1 , packet1.yaw , packet1.pitch , packet1.ptz_status , packet1.trace_status , packet1.deviceid );
    mavlink_msg_camera_pod_states_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_fmt_pos_yaw(system_id, component_id, last_msg);
    ...
    mavlink_test_attack_status(system_id, component_id, last_msg);
    mavlink_test_formation_config(system_id, component_id, last_msg);
    mavlink_test_formation_set(system_id, component_id, last_msg);
    mavlink_test_serial_number_item(system_id, component_id, last_msg);
    mavlink_test_serial_number_request(system_id, component_id, last_msg);
    mavlink_test_wheel_distance(system_id, component_id, last_msg);
    mavlink_test_winch_status(system_id, component_id, last_msg);
    mavlink_test_fmt_global_pos(system_id, component_id, last_msg);
    ...
    mavlink_test_flight_num_msg(system_id, component_id, last_msg);
    mavlink_test_target_position(system_id, component_id, last_msg);
    mavlink_test_fuze_control(system_id, component_id, last_msg);
    mavlink_test_fuze_states(system_id, component_id, last_msg);
    mavlink_test_camera_pod_control(system_id, component_id, last_msg);
    mavlink_test_camera_pod_states(system_id, component_id, last_msg);
}
