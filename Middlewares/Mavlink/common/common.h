...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NAV_ATTACK=70, /* Land at location. |Minimum target altitude if landing is aborted (0 = undefined/use system default).| Precision land mode.| Empty.| Desired yaw angle. NaN to use the current system yaw heading mode (e.g. yaw towards next waypoint, yaw to home, etc.).| Latitude.| Longitude.| Landing altitude (ground level in current frame).|  */
   MAV_CMD_NAV_WAYPOINT_CAN_BE_AS_RTL=75, /* Navigate to waypoint can be as rtl destination. |Hold time. (ignored by fixed wing, time to stay at waypoint for rotary wing)| Acceptance radius (if the sphere with this radius is hit, the waypoint counts as reached)| 0 to pass through the WP, if > 0 radius to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.| Desired yaw angle at waypoint (rotary wing). NaN to use the current system yaw heading mode (e.g. yaw towards next waypoint, yaw to home, etc.).| Latitude| Longitude| Altitude|  */
...
typedef enum MAV_SENSOR_ORIENTATION
{
   ...
   MAV_SENSOR_ROTATION_PITCH_45=41, /* Pitch: 45 | */
...
#include "./mavlink_msg_fmt_pos_yaw.h"
...
#include "./mavlink_msg_attack_status.h"
#include "./mavlink_msg_formation_config.h"
#include "./mavlink_msg_formation_set.h"
#include "./mavlink_msg_serial_number_item.h"
#include "./mavlink_msg_serial_number_request.h"
#include "./mavlink_msg_wheel_distance.h"
#include "./mavlink_msg_winch_status.h"
#include "./mavlink_msg_fmt_global_pos.h"
...
#include "./mavlink_msg_fuze_control.h"
#include "./mavlink_msg_fuze_states.h"
#include "./mavlink_msg_camera_pod_control.h"
#include "./mavlink_msg_camera_pod_states.h"
